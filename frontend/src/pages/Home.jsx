...
const Home = () => {
 ...
 async function findTrip() {
  if (!pickup.trim() || !destination.trim()) {
    return alert("Please fill both pickup and destination");
  }
  ...
  return (
    <div className="h-screen relative overflow-hidden">
      ...
      <div className="flex flex-col justify-end h-screen absolute top-0 w-full">
          ...
          <form onSubmit={submitHandler}>
            ...
            <button
              ...
              className={`mt-4 w-full px-6 py-2 rounded-lg text-white font-medium ${
                isDisabled ? "bg-gray-400 cursor-not-allowed" : "bg-black"
              }`}
            >
              Find Trip
            </button>
        ...
        <div
          ref={panelRef}
          className="bg-white h-[0] max-h-[500px] overflow-y-auto transition-all duration-300 ease-in-out"
        >
          <LocationSearchPanel
            suggestions={
              activeField === "pickup"
